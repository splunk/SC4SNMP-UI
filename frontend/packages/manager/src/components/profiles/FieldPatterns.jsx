...
function FieldPatterns(props){
    ...
    const handleRequestAdd = () => {
        ...
        setRowItems((prev) =>
          FormRows.addRow(
            <FormRows.Row index={newIndex} key={keyID} onRequestRemove={handleRequestRemove}>
                    <div style={validationGroup}>
                        <Text defaultValue="" onChange={e => handleItemValue(indices[`${keyID}`], e)}
                        error={((ValCtx.conditionPatternsErrors && indices[`${keyID}`] in ValCtx.conditionPatternsErrors))}/>
                        {((ValCtx.conditionPatternsErrors && indices[`${keyID}`] in ValCtx.conditionPatternsErrors) ?
                            ValCtx.conditionPatternsErrors[indices[`${keyID}`]].map((el) =>
